...
namespace Hermany.AoC._2022
{
    ...
    {
        public string P1Assertion { get => "13140"; }
       ...
       --- Part Two ---
        ...
        Your puzzle answer was FGCUZREC.
        */
        public string P2(string[] input)
        {
            ...
            // store screen as flat list with rows mod 40
            var screen = new List<bool>();

            foreach (var instruction in input)
            {
                screen.Add(cycle % 40 == X - 1 || cycle % 40 == X || cycle % 40 == X + 1);
