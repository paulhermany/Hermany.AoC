...
namespace Hermany.AoC._2022
{
    public class _16 : ISolution
    {
        ...
        */
        ...
        {
            // this will never finish in your lifetime
            ...
            var optimized = valves.Where(_ => _.Value.rate != 0).Select(_ => _.Key);

            // saving this for another search-max approach
            //var maxPressure = GetMaxPressure("AA", "AA", 26, 26, optimized, valves);
        ...
        //public int GetMaxPressure(string key1, string key2, int timeRemaining1, int timeRemaining2)
    }
}