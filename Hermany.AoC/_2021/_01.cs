...
namespace Hermany.AoC._2021
{
    public class _01 : ISolution
    {
        ...
        */
        ...
        {
            return input.SelectTwo((a, b) => int.Parse(b) > int.Parse(a)).Count(_ => _).ToString();
        }
        ...
        */
        ...
        {
            return input.SelectThree((a, b, c) => int.Parse(a) + int.Parse(b) + int.Parse(c)).SelectTwo((a, b) => b > a).Count(_ => _).ToString();
        }
    }
}
