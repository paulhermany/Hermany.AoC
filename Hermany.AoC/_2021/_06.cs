...
namespace Hermany.AoC._2021
{
    ...
    {
        public string P1Assertion { get => "5934"; }
        public string P2Assertion { get => "26984457539"; }
        /*
        --- Day 6: Lanternfish ---
        ...
        */
        ...
        {
            var initial = input[0].Split(',').Select(int.Parse).ToArray();
            var list = Enumerable.Repeat((long)0, 9).ToList();
